...
### Fixed
- WordPress auto-login no longer fails with "No administrator found" when WP-CLI prints PHP deprecation/warning notices to stdout before the user ID — those lines are now filtered out before parsing
